...
export default function ContactSection() {
  ...
  const handleSubmitBrief = async (e: React.FormEvent) => {
    ...
    if (!clientEmail.trim() || !emailPattern.test(clientEmail)) {
    ...
    try {
      ...
      if (data.status === "error") throw new Error("Server returned an error");
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-2 pt-2 border-t border-[var(--border-color)] relative group/info-row">
                    <a
                      href="https://mail.google.com/mail/?view=cm&to=Gillaxediting@gmail.com"
              ...
              {!isSuccess ? (
                ...
                >
                  <div>
                    ...
                    {/* Form Success/Error inline messages are handled below */}
                    ...
                    <form onSubmit={handleSubmitBrief} className="space-y-4">
                      ...
                      {formError && (
                        <div className="pt-2 text-[11px] font-mono text-red-500 font-bold uppercase tracking-wider text-center">
                          {formError}
                        </div>
                      )}
